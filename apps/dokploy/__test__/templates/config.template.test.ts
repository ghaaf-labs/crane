import type { Schema } from "@crane/server/templates";
import type { CompleteTemplate } from "@crane/server/templates/processors";
import { processTemplate } from "@crane/server/templates/processors";
